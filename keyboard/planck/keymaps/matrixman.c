...
[_SYMB_L] = {
   {KC_GRV,   KC_TILD,    KC_ASTR,    KC_AMPR,    KC_SLSH,    KC_LSTH,          KC_GRTH,          KC_BSLS,  KC_7,    KC_8,    KC_9,    KC_PIPE}
  ,{KC_UNDS,  KC_CIRC,    KC_PERC,    KC_DLR,     KC_LPRN,    CTL_T(KC_LBRC),   CTL_T(KC_RBRC),   KC_RPRN,  KC_4,    KC_5,    KC_6,    KC_MINS}
  ,{KC_EQL ,  KC_HASH,    KC_AT,      KC_EXLM,    KC_LCBR,    KC_TRNS,          KC_TRNS,          KC_RCBR,  KC_1,    KC_2,    KC_3,    KC_PLUS}
  ,{KC_DQOT,  KC_TRNS,    KC_COMM,    KC_QSTN,    KC_TRNS,    KC_TRNS,          KC_TRNS,          KC_SCLN,  KC_0,    KC_DOT,  KC_DOT,  KC_TRNS}
},
...
[_SYMB_R] = {
  ...
  ,{KC_EQL ,  KC_HASH,    KC_AT,      KC_EXLM,    KC_LCBR,    KC_TRNS,  KC_TRNS,  KC_RCBR,  KC_1,    KC_2,    KC_3,    KC_PLUS}
  ,{KC_DQOT,  KC_TRNS,    KC_COMM,    KC_QSTN,    KC_COLN,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_0,    KC_DOT,  KC_TRNS, KC_TRNS}
},
